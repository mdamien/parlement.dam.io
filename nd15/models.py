...
class Amendement(models.Model):
    ...
    sous_amendement_de = models.CharField(max_length=16, blank=True, null=True)
    ...
    auteur_id = models.BigIntegerField(blank=True, null=True)
    ...
    nb_multiples = models.BigIntegerField(blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
...
# Multiple-columns primary key found for table "article_version"but not yet implemented, taking the first one
...
class Parlementaire(models.Model):
    ...
    type = models.CharField(max_length=255, blank=True, null=True)
    groupe_acronyme = models.CharField(max_length=16, blank=True, null=True)
    parti = models.CharField(max_length=255, blank=True, null=True)
    ...
    url_ancien_cpc = models.TextField(blank=True, null=True)
    url_nouveau_cpc = models.TextField(blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    slug = models.CharField(unique=True, max_length=255, blank=True, null=True)
...
class ParlementaireOrganisme(models.Model):
    ...
    fin_fonction = models.DateField(blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    ...
    class Meta:
        ...
        unique_together = (('organisme_id', 'parlementaire_id', 'fin_fonction'),)
...
class ParlementaireScrutin(models.Model):
    ...
    par_delegation = models.IntegerField(blank=True, null=True)
    delegataire_parlementaire_id = models.BigIntegerField(blank=True, null=True)
    mise_au_point_position = models.CharField(max_length=255, blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'parlementaire_scrutin'
        unique_together = (('scrutin_id', 'parlementaire_id'),)
...
class Scrutin(models.Model):
    id = models.BigAutoField(primary_key=True)
    numero = models.BigIntegerField(unique=True, blank=True, null=True)
    annee = models.BigIntegerField(blank=True, null=True)
    numero_semaine = models.BigIntegerField(blank=True, null=True)
    date = models.DateField(blank=True, null=True)
    seance_id = models.BigIntegerField(blank=True, null=True)
    nombre_votants = models.BigIntegerField(blank=True, null=True)
    nombre_pours = models.BigIntegerField(blank=True, null=True)
    nombre_contres = models.BigIntegerField(blank=True, null=True)
    nombre_abstentions = models.BigIntegerField(blank=True, null=True)
    type = models.CharField(max_length=255, blank=True, null=True)
    sort = models.CharField(max_length=255, blank=True, null=True)
    titre = models.TextField(blank=True, null=True)
    texteloi_id = models.BigIntegerField(blank=True, null=True)
    amendement_id = models.BigIntegerField(blank=True, null=True)
    sujet = models.TextField(blank=True, null=True)
    demandeurs = models.TextField(blank=True, null=True)
    demandeurs_groupes_acronymes = models.CharField(max_length=64, blank=True, null=True)
    avis_gouvernement = models.CharField(max_length=16, blank=True, null=True)
    avis_rapporteur = models.CharField(max_length=16, blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
...
class Texteloi(models.Model):
    id = models.CharField(primary_key=True, max_length=16, blank=True)
    nb_commentaires = models.BigIntegerField(blank=True, null=True)
    legislature = models.BigIntegerField(blank=True, null=True)
    numero = models.BigIntegerField(blank=True, null=True)
...
class TitreLoi(models.Model):
    ...
    nb_commentaires = models.BigIntegerField(blank=True, null=True)
    texteloi_id = models.CharField(max_length=16, blank=True, null=True)
    leveltype = models.CharField(max_length=16, blank=True, null=True)
    level1 = models.CharField(max_length=8, blank=True, null=True)
    level2 = models.CharField(max_length=8, blank=True, null=True)
    level3 = models.CharField(max_length=8, blank=True, null=True)
    level4 = models.CharField(max_length=8, blank=True, null=True)
    titre = models.TextField(blank=True, null=True)
    expose = models.TextField(blank=True, null=True)
    parlementaire_id = models.BigIntegerField(blank=True, null=True)
    date = models.DateField(blank=True, null=True)
