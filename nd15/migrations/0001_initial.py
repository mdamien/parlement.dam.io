    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sous_amendement_de', models.CharField(blank=True, max_length=16, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, max_length=255, null=True)),
                ('groupe_acronyme', models.CharField(blank=True, max_length=16, null=True)),
        ...
        migrations.CreateModel(
            name='ParlementaireScrutin',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('parlementaire_groupe_acronyme', models.CharField(blank=True, max_length=16, null=True)),
                ('position', models.CharField(blank=True, max_length=255, null=True)),
                ('position_groupe', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('mise_au_point_position', models.CharField(blank=True, max_length=255, null=True)),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('numero', models.BigIntegerField(blank=True, null=True, unique=True)),
                ...
                ('demandeurs_groupes_acronymes', models.CharField(blank=True, max_length=64, null=True)),
                ('avis_gouvernement', models.CharField(blank=True, max_length=16, null=True)),
                ('avis_rapporteur', models.CharField(blank=True, max_length=16, null=True)),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Texteloi',
            fields=[
                ('id', models.CharField(blank=True, max_length=16, primary_key=True, serialize=False)),
                ('nb_commentaires', models.BigIntegerField(blank=True, null=True)),
                ('legislature', models.BigIntegerField(blank=True, null=True)),
                ('numero', models.BigIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nb_commentaires', models.BigIntegerField(blank=True, null=True)),
                ('texteloi_id', models.CharField(blank=True, max_length=16, null=True)),
                ('leveltype', models.CharField(blank=True, max_length=16, null=True)),
                ('level1', models.CharField(blank=True, max_length=8, null=True)),
                ('level2', models.CharField(blank=True, max_length=8, null=True)),
                ('level3', models.CharField(blank=True, max_length=8, null=True)),
                ('level4', models.CharField(blank=True, max_length=8, null=True)),
                ('titre', models.TextField(blank=True, null=True)),
                ('expose', models.TextField(blank=True, null=True)),
                ('parlementaire_id', models.BigIntegerField(blank=True, null=True)),
                ('date', models.DateField(blank=True, null=True)),
